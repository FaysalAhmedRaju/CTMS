    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  echo form_open(base_url().'index.php/report/tallyEntryFormWithIgmContInfo',$attributes);
					...
					<td>
						<table border="0" width="450px" align="center">
							...
							<tr>
								...
								<td><input type="text" name="rotation" id="rotation" style="width:150px;"></td>
							</tr>
							<tr>
								<td><label for="field3"><font color='red'><b>*</b></font>Container:</label></td>
								<td><input type="text" name="cont" id="cont" style="width:150px;"></td>
							</tr>
							<tr>
								<td align="right" colspan="2"></td>
							</tr>								
