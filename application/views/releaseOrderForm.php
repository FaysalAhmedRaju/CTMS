    ...
    <div class="content_resize_1">
      <div class="mainbar_1">
        <div class="article">
		  ...
		  //,'target'=>'_BLANK'
		//  echo form_open(base_url().'index.php/report/releaseOrderFormView',$attributes);
		 echo form_open(base_url().'index.php/report/releaseorderpdf',$attributes);
		...
		<div class="img">
		 ...
		 <table align="center" border=0>	
						<tr align="center">
							...
							<td align="left">
									<label for="RlsOrder" style="font-size:11px;width:100%;margin:0;padding:0;text-align:left;width:75%;">Release Order</label>
									<?php 	$data = array(
													'name'        => 'options',
													'id'          => 'options',
													'value'       => 'RlsOrder',
										...
										<td align="left">
										<label for="Bill" style="font-size:11px;width:100%;margin:0;padding:0;text-align:left;width:75%;">BILL</label>
										<?php 	$data = array(
													'name'        => 'options',
													'id'          => 'options',
													'value'       => 'Bill',
