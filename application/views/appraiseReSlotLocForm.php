		...
		<div class="img">
			 ...
			 <table style="border:solid 1px #ccc;" width="450px" align="center" cellspacing="0" cellpadding="0">
				...
				<table border="0" width="400px" align="center">
								<tr>
									<td align="center" ><label><font color='red'><b>*</b></font>From Date:</label>								
											<script>
											  $(function() {
												$( "#fromdate" ).datepicker({
													changeMonth: true,
								...
								<tr>
									...
									<!--td align="center" ><label><font color='red'><b>*</b></font>To Date:</label>								
											<script>
											  $(function() {
												$( "#todate" ).datepicker({
													changeMonth: true,
									...
									<td> 
										<input type="text" style="width:120px;" id="todate" name="todate" value=""/>
									</td-->
