		...
		<table align="center"> 
						...
						<option value="">--Select--</option>
                            ...
                            <tr>
                                ...
                                <th align=""><nobr>&nbsp; &nbsp;&nbsp; : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</nobr></th>
                                <th><input class="read" type="text" style="width:180px;"  id="total_equip" name="total_equip"   <?php if($editFlag==1){?> value="<?php echo $select_result[0]['equip_num']; ?>" <?php }?> ></th>
				
                            </tr>  
							<tr>
                                <th align="left"><nobr>Out of Order</nobr></th>
                                <th align=""><nobr>&nbsp; &nbsp;&nbsp; : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</nobr></th>
                                <th><input class="read" type="text" style="width:180px;"  id="nonOperational" name="nonOperational"   <?php if($editFlag==1){?> value="<?php echo $select_result[0]['non_operational']; ?>" <?php }?> ></th>
