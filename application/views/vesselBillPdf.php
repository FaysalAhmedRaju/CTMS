...
<head>
		<table align="center" width="95%">
			...
			<tr>
				<td align="center"><b>BILL FOR PORT & PILOTAGE CHARGES ON VESSEL(PCT)</b></td>
			</tr>	
		</table>	
		...
		<div align ="center">
			<table align="center" width="95%">
				...
				<tr>
					...
					<td align="left">: &nbsp;&nbsp;<?php echo $bill_rslt[0]['bill_no'];?></td>
					<td align="left"></td>
			...
			<table align="center" width="95%">
				...
				<tr>
					...
					<td align="left"><?php echo $bill_rslt[$i]['rateBilled'];?></td>
					...
					<td align="right"><?php if (strpos($bill_rslt[$i]['bdChraged'], '.') !== false) {
												echo $bill_rslt[$i]['bdChraged'];
											} else {
												echo $bill_rslt[$i]['bdChraged'].".00";
											}?></td>
					<td align="right"><?php if (strpos($bill_rslt[$i]['bdVat'], '.') !== false) {
												echo $bill_rslt[$i]['bdVat'];
											} else {
												echo $bill_rslt[$i]['bdVat'].".00";
											}?></td>
				</tr>
				<?php   
			...
			//	 $vatTotalCharge=(int)$vatTotal;
				...
				<tr>
					...
					<td align="right"><?php if (strpos($vatTotal, '.') !== false) {
												echo $vatTotal;
											} else {
												echo $vatTotal.".00";
											}?></td>
			...
			<table align="center" width="85%">
				<tr>
					...
					<font size="4"><b>IN WORDS  : </font></b> <?php  echo numtowords($total);?></b>
					</td>
				</tr>	
				<tr>	
					<td colspan="6" align ="left">
					  <font size="4"><b> VAT &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</font></b> <?php echo numtowords($vatTotal);?></b>
					</td>
				</tr>
				<tr>
					<td colspan="6">&nbsp;</td>
				...
				<tr>
					<td colspan="6">PRINT DATE: &nbsp;&nbsp;&nbsp;<?php echo date("D M j"); ?></td>
