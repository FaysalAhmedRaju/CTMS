	...
	<table align="center" cellspacing="0" cellpadding="1">		
		...
		<tr>
			...
			while($k>=$minColLimitUp)
			{
				...
				{
					$strPos = "select ctmsmis.mis_exp_unit.pod,sparcsn4.inv_unit.freight_kind,sparcsn4.inv_unit.id,r.id as mlo,
			...
			{			
				...
				{
					$strPosCentre = "select ctmsmis.mis_exp_unit.pod,sparcsn4.inv_unit.freight_kind,sparcsn4.inv_unit.id,r.id as mlo,right(sparcsn4.ref_equip_type.nominal_length,2) as size, ceil((ctmsmis.mis_exp_unit.goods_and_ctr_wt_kg/1000)) as tons,sparcsn4.ref_equip_type.iso_group as rfr_connect 
					from ctmsmis.mis_exp_unit 
					inner join sparcsn4.inv_unit on sparcsn4.inv_unit.gkey=ctmsmis.mis_exp_unit.gkey 
					inner join sparcsn4.inv_unit_equip on sparcsn4.inv_unit_equip.unit_gkey=sparcsn4.inv_unit.gkey
					inner join sparcsn4.ref_equipment on sparcsn4.ref_equipment.gkey=sparcsn4.inv_unit_equip.eq_gkey
			...
			while($l<=$rcLimit)
			{
				...
				{
				$strPosRight = "select ctmsmis.mis_exp_unit.pod,sparcsn4.inv_unit.freight_kind,sparcsn4.inv_unit.id,r.id as mlo,right(sparcsn4.ref_equip_type.nominal_length,2) as size, ceil((ctmsmis.mis_exp_unit.goods_and_ctr_wt_kg/1000)) as tons,sparcsn4.ref_equip_type.iso_group as rfr_connect 
				from ctmsmis.mis_exp_unit 
				inner join sparcsn4.inv_unit on sparcsn4.inv_unit.gkey=ctmsmis.mis_exp_unit.gkey 
				inner join sparcsn4.inv_unit_equip on sparcsn4.inv_unit_equip.unit_gkey=sparcsn4.inv_unit.gkey
				inner join sparcsn4.ref_equipment on sparcsn4.ref_equipment.gkey=sparcsn4.inv_unit_equip.eq_gkey
		...
		<?php
			...
			//echo "KB=".$kbelow."<br>";
				...
				{
					$strPosbelow = "select ctmsmis.mis_exp_unit.pod,sparcsn4.inv_unit.freight_kind,sparcsn4.inv_unit.id,r.id as mlo,right(sparcsn4.ref_equip_type.nominal_length,2) as size, ceil((ctmsmis.mis_exp_unit.goods_and_ctr_wt_kg/1000)) as tons,sparcsn4.ref_equip_type.iso_group as rfr_connect 
					from ctmsmis.mis_exp_unit 
					inner join sparcsn4.inv_unit on sparcsn4.inv_unit.gkey=ctmsmis.mis_exp_unit.gkey 
					inner join sparcsn4.inv_unit_equip on sparcsn4.inv_unit_equip.unit_gkey=sparcsn4.inv_unit.gkey
					inner join sparcsn4.ref_equipment on sparcsn4.ref_equipment.gkey=sparcsn4.inv_unit_equip.eq_gkey
			...
			{	
				...
				{
					$strPosCentreBelow = "select ctmsmis.mis_exp_unit.pod,sparcsn4.inv_unit.freight_kind,sparcsn4.inv_unit.id,r.id as mlo,right(sparcsn4.ref_equip_type.nominal_length,2) as size, ceil((ctmsmis.mis_exp_unit.goods_and_ctr_wt_kg/1000)) as tons,sparcsn4.ref_equip_type.iso_group as rfr_connect 
					from ctmsmis.mis_exp_unit 
					inner join sparcsn4.inv_unit on sparcsn4.inv_unit.gkey=ctmsmis.mis_exp_unit.gkey 
					inner join sparcsn4.inv_unit_equip on sparcsn4.inv_unit_equip.unit_gkey=sparcsn4.inv_unit.gkey
					inner join sparcsn4.ref_equipment on sparcsn4.ref_equipment.gkey=sparcsn4.inv_unit_equip.eq_gkey
			...
			//echo "LB=".$lBelow."M=".($maxColLimit-1)."<br>";
				...
				{				
					$strPosRightBelow = "select ctmsmis.mis_exp_unit.pod,sparcsn4.inv_unit.freight_kind,sparcsn4.inv_unit.id,r.id as mlo,right(sparcsn4.ref_equip_type.nominal_length,2) as size, ceil((ctmsmis.mis_exp_unit.goods_and_ctr_wt_kg/1000)) as tons,sparcsn4.ref_equip_type.iso_group as rfr_connect 
					from ctmsmis.mis_exp_unit 
					inner join sparcsn4.inv_unit on sparcsn4.inv_unit.gkey=ctmsmis.mis_exp_unit.gkey 
					inner join sparcsn4.inv_unit_equip on sparcsn4.inv_unit_equip.unit_gkey=sparcsn4.inv_unit.gkey
					inner join sparcsn4.ref_equipment on sparcsn4.ref_equipment.gkey=sparcsn4.inv_unit_equip.eq_gkey
