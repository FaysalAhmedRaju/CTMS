	...
	<?php } ?>
			...
			<td>
				<?php 
					...
					if($row->Block_No)
					{
						if ($row->Block_No=="HS1" or $row->Block_No=="Y2")
							echo "UNIT-1 (".$row->Block_No.")";
						else if ($row->Block_No=="YMN")
							echo "UNIT-1 (MN)";
						else if ($row->Block_No=="Y3" or $row->Block_No=="HS6" or $row->Block_No=="HS9" or $row->Block_No=="Y10" or $row->Block_No=="Y11")
							echo "UNIT-2 (".$row->Block_No.")";
						else if ($row->Block_No=="HS7" or $row->Block_No=="Y8" or $row->Block_No=="Y8B" or $row->Block_No=="BAPX")
							echo "UNIT-3 (".$row->Block_No.")";
						else if ($row->Block_No=="Y5" or $row->Block_No=="Y6X")
							echo "UNIT-4 (".$row->Block_No.")";
						else if ($row->Block_No=="YCW" or $row->Block_No=="AB")
							echo "UNIT-5 (".$row->Block_No.")";
						else{
							echo $row->Block_No;
						}
					}
