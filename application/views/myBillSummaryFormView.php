    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  echo form_open(base_url().'index.php/report/myBillSummaryviews',$attributes);
			...
			<div class="img">
			 ...
			 <table style="border:solid 1px #ccc;" width="300px" align="center" cellspacing="0" cellpadding="0">
				...
				<table border="0" width="450px" align="center">
								...
								<tr>
									<td colspan="2" align="center" width="70px"><?php $arrt = array('name'=>'submit_login','id'=>'submit','value'=>'Click','class'=>'login_button'); echo form_submit($arrt);?></td>
