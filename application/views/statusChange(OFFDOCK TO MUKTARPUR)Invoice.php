		...
		<div align ="center">
			<table align="center" width="95%">
				...
				<tr>
					...
					<td align="left">: &nbsp; STATUS CHANGE BILL</td>
					<td align="left"></td>
			...
			<table align="center" width="95%" border='0' style="overflow: wrap">
				<tr>
					<td colspan="10">
				...
				<tr>
					...
					<td style="width:80px" align="right">RATE</td>
					<td style="width:80px" align="right">AMOUNT BDT</td>
					<td style="width:80px" align="right">VAT BDT</td>
					<td style="width:80px" align="right">TOTAL BDT</td>
