    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  echo form_open(base_url().'index.php/report/shedUpdateFormView',$attributes);
					...
					<tr>
						...
						<tr>									
							<td align="left" ><label><font color='red'><b>*</b></font>Rotation No : </label>
								<td> 
								<input type="text" style="width:150px;" id="rotation" name="rotation"/>
								</td>
							</td>
								
						</tr>
							<tr>
								<td align="left" ><label><font color='red'><b>*</b></font>Container No : 
