...
<!--					<td align="left"></td>
			...
			<table align="center" width="95%">
				...
				<tr>
					...
					<td align="center" style="width:100px">CONTAINER NO</td>
					<td align="center" style="width:30px">SIZE</td>
					<td align="center" style="width:100px">HEIGHT</td>
					<td align="center" style="width:50px">STATUS</td>
					<!--td align="center">IMT ROT</td-->
					<!--<td align="center">IMT ATA</td>-->
					<td align="center" style="width:100px">LANDING DATE</td>
					<td align="center" style="width:150px">ISSUE DATE OF LETTER</td>
					<!--td  align="center">DATE OF LETTER</td>
                    <td align="center">From Depo</td-->
					<td align="center" style="width:50px">VAT(%)</td>
