		...
		<tr>
			...
			while($k>=$minColLimitUp)
			{
				...
				if($rowbay->paired==0)
				{
					...
					$strPrevCont = "select ctmsmis.mis_inv_unit.size from ctmsmis.mis_exp_unit 
					inner join ctmsmis.mis_inv_unit on mis_inv_unit.gkey=ctmsmis.mis_exp_unit.gkey
				...
				if($numrowPrevCont>0 and $rowbay->paired==0 and $rowPrevCont->size>20)
				{
					?>
				...
				{
					$strPos = "select ctmsmis.mis_exp_unit.pod,ctmsmis.mis_inv_unit.freight_kind,ctmsmis.mis_inv_unit.id,ctmsmis.mis_inv_unit.mlo,ctmsmis.mis_inv_unit.size,
					ceil((ctmsmis.mis_exp_unit.goods_and_ctr_wt_kg/1000)) as tons,ctmsmis.mis_inv_unit.rfr_connect
			...
			{			
				...
				if($rowbay->paired==0)
				{
					...
					$strPrevContCntr = "select ctmsmis.mis_inv_unit.size from ctmsmis.mis_exp_unit 
					inner join ctmsmis.mis_inv_unit on mis_inv_unit.gkey=ctmsmis.mis_exp_unit.gkey
				...
				if($numrowPrevContCntr>0 and $rowbay->paired==0 and $rowPrevContCntr->size>20)
				{
					?>
					<td class="gridcolor" align="center">
				...
				{
					$strPosCentre = "select ctmsmis.mis_exp_unit.pod,ctmsmis.mis_inv_unit.freight_kind,ctmsmis.mis_inv_unit.id,ctmsmis.mis_inv_unit.mlo,ctmsmis.mis_inv_unit.size,
						ceil((ctmsmis.mis_exp_unit.goods_and_ctr_wt_kg/1000)) as tons,ctmsmis.mis_inv_unit.rfr_connect
						from ctmsmis.mis_exp_unit
						inner join ctmsmis.mis_inv_unit on ctmsmis.mis_inv_unit.gkey=ctmsmis.mis_exp_unit.gkey
			...
			while($l<=$rcLimit)
			{
				...
				if($rowbay->paired==0)
				{
					...
					$strPrevContRight = "select ctmsmis.mis_inv_unit.size from ctmsmis.mis_exp_unit 
					inner join ctmsmis.mis_inv_unit on mis_inv_unit.gkey=ctmsmis.mis_exp_unit.gkey
				...
				if($numrowPrevContRight>0 and $rowbay->paired==0 and $rowPrevContRight->size>20)
				{
					?>
					<td class="gridcolor" align="center">
				...
				{
				$strPosRight = "select ctmsmis.mis_exp_unit.pod,ctmsmis.mis_inv_unit.freight_kind,ctmsmis.mis_inv_unit.id,ctmsmis.mis_inv_unit.mlo,ctmsmis.mis_inv_unit.size,
				ceil((ctmsmis.mis_exp_unit.goods_and_ctr_wt_kg/1000)) as tons,ctmsmis.mis_inv_unit.rfr_connect
				from ctmsmis.mis_exp_unit
				inner join ctmsmis.mis_inv_unit on ctmsmis.mis_inv_unit.gkey=ctmsmis.mis_exp_unit.gkey
		...
		<?php
			...
			//echo "KB=".$kbelow."<br>";
				...
				if($rowbay->paired==0)
				{
					...
					$strPrevContBelow = "select ctmsmis.mis_inv_unit.size from ctmsmis.mis_exp_unit 
					inner join ctmsmis.mis_inv_unit on mis_inv_unit.gkey=ctmsmis.mis_exp_unit.gkey
				...
				if($numrowPrevContBelow>0 and $rowbay->paired==0 and $rowPrevContBelow->size>20 and $kbelow <=$maxColLimit)
				{
					?>
					<td class="gridcolor" align="center">
				...
				{
					$strPosbelow = "select ctmsmis.mis_exp_unit.pod,ctmsmis.mis_inv_unit.freight_kind,ctmsmis.mis_inv_unit.id,ctmsmis.mis_inv_unit.mlo,ctmsmis.mis_inv_unit.size,
					ceil((ctmsmis.mis_exp_unit.goods_and_ctr_wt_kg/1000)) as tons,ctmsmis.mis_inv_unit.rfr_connect
					from ctmsmis.mis_exp_unit
					inner join ctmsmis.mis_inv_unit on ctmsmis.mis_inv_unit.gkey=ctmsmis.mis_exp_unit.gkey
			...
			{	
				...
				if($rowbay->paired==0)
				{
					...
					$strPrevContBelowCntr = "select ctmsmis.mis_inv_unit.size from ctmsmis.mis_exp_unit 
					inner join ctmsmis.mis_inv_unit on mis_inv_unit.gkey=ctmsmis.mis_exp_unit.gkey
				...
				if($numrowPrevContBelowCntr>0 and $rowbay->paired==0 and $rowPrevContBelowCntr->size>20)
				{
					?>
					<td class="gridcolor" align="center">
				...
				{
					$strPosCentreBelow = "select ctmsmis.mis_exp_unit.pod,ctmsmis.mis_inv_unit.freight_kind,ctmsmis.mis_inv_unit.id,ctmsmis.mis_inv_unit.mlo,ctmsmis.mis_inv_unit.size,
						ceil((ctmsmis.mis_exp_unit.goods_and_ctr_wt_kg/1000)) as tons,ctmsmis.mis_inv_unit.rfr_connect
						from ctmsmis.mis_exp_unit
						inner join ctmsmis.mis_inv_unit on ctmsmis.mis_inv_unit.gkey=ctmsmis.mis_exp_unit.gkey
			...
			//echo "LB=".$lBelow."M=".($maxColLimit-1)."<br>";
				...
				if($rowbay->paired==0)
				{
					...
					$strPrevContBelowRight = "select ctmsmis.mis_inv_unit.size from ctmsmis.mis_exp_unit 
					inner join ctmsmis.mis_inv_unit on mis_inv_unit.gkey=ctmsmis.mis_exp_unit.gkey
				...
				if($numrowPrevContBelowRight>0 and $rowbay->paired==0 and $rowPrevContBelowRight->size>20 and $lBelow <=$maxColLimit-1)
				{
					?>
					<td class="gridcolor" align="center">
				...
				{				
					$strPosRightBelow = "select ctmsmis.mis_exp_unit.pod,ctmsmis.mis_inv_unit.freight_kind,ctmsmis.mis_inv_unit.id,ctmsmis.mis_inv_unit.mlo,ctmsmis.mis_inv_unit.size,
					ceil((ctmsmis.mis_exp_unit.goods_and_ctr_wt_kg/1000)) as tons,ctmsmis.mis_inv_unit.rfr_connect
					from ctmsmis.mis_exp_unit
					inner join ctmsmis.mis_inv_unit on ctmsmis.mis_inv_unit.gkey=ctmsmis.mis_exp_unit.gkey
					where ctmsmis.mis_exp_unit.vvd_gkey=$vvdGkey and left(stowage_pos,2) in($bay) and right(stowage_pos,4)='$posRightBelow' and right(stowage_pos,2)<80 order by stowage_pos";
