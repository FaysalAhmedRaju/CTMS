...
<?php
	...
	$sqlLogTime=mysql_query("select logDate,logBy from ctmsmis.mis_equip_log_in_out_info where logEquip='$row->eq' and logType='in' and  logDate $cond order by logDate limit 1",$con_ctmsmis);
	...
	$sqlLogOut=mysql_query("select logDate from ctmsmis.mis_equip_log_in_out_info where logEquip='$row->eq' and logType='out' and  logDate $cond  order by logDate desc limit 1",$con_ctmsmis);
