    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  //echo form_open(base_url().'index.php/report/myExportContainerLoadedReportView',$attributes);
		  echo form_open(base_url().'index.php/report/chkExportLoadedContainerMloWise',$attributes);
						...
						<td>
							<table>
								...
								<tr>
										...
										<td align="left" ><label><font color='red'><b>*</b></font>Rotation No.</label>
										<td>
								...
								<tr>
									<td align="center" width="70px"><?php $arrt = array('name'=>'detail','id'=>'submit','value'=>'Detail','class'=>'login_button'); echo form_submit($arrt);?></td>
									<td align="center" width="70px"><?php $arrt = array('name'=>'summary','id'=>'submit','value'=>'Summary','class'=>'login_button'); echo form_submit($arrt);?></td>
