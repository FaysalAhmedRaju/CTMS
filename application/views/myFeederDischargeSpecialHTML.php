    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  echo form_open(base_url().'index.php/report/specialReportView',$attributes);
		...
		<div class="img">
			 ...
			 <table style="border:solid 1px #ccc;" width="350px" align="center" cellspacing="0" cellpadding="0">
				...
				<table border="0" width="300px" align="center">
								...
								<tr><br />
									<td align="right" ><label for="rotation_no">Imp Rotation No:<em>&nbsp;</em></label></td>
									<td align="left" >
										...
										<table align="center">
											<tr>
												<td>
													...
													<?php 	
														$data = array('name'=> 'options','id'=> 'options','value' => 'xl','checked'=> FALSE,'style' => 'width:2em;border:none;display:block;float:left;margin:0 5px 0 0;padding:0;',);
												...
												<td>
													...
													<?php 	
														$data = array('name'=> 'options','id'=> 'options','value' => 'pdf','checked'=> TRUE,'style' => 'width:2em;border:none;display:block;float:left;margin:0 5px 0 0;padding:0;',);
														echo form_radio($data); 
													?>
												</td>
											</tr>
