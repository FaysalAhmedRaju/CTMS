    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  echo form_open(base_url().'index.php/report/myImportContainerDischargeReportViewLast24Hours',$attributes);
			 ...
			 <table style="border:solid 1px #ccc;" width="350px" align="center" cellspacing="0" cellpadding="0">
				...
				<table border="0" width="300px" align="center">
								...
								<tr><br />
									...
									<td>
									<input type="text" style="width:130px;" id="ddl_imp_rot_no" name="ddl_imp_rot_no"> 
									</td>
								</tr>
									<tr>
									<td align="left" ><label><font color='red'><b>*</b></font>Date:</label></td>
									
											<td> 
											<input type="text" style="width:130px;" id="datepicker" name="fromdate" value="<?php echo date("Y-m-d"); ?>"/>
										</td>
											 <script>
											  $(function() {
