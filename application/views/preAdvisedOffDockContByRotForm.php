    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  echo form_open(base_url().'index.php/report/preAdvisedOffDockContByRotReport',$attributes);
					...
					<tr>
						<td align="right" colspan="2"></td>
									...
									<tr>
										...
										<td>
											<input type="text" name="rotation" id="rotation" onblur="getMlo(this.value)" style="width:150px;">	
										</td>
									</tr>
									<tr>
										<td><label for="field3"><font color='red'><b>*</b></font>MLO:</label></td>
										<td>
											<select name="serch_by" id="serch_by" required>
