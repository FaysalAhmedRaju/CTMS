	...
	<div align ="center">
		<table align="center" width="95%">
			...
			<tr>
				...
				<td align="left">:</td>
				<td align="left">DISCHARGING BILL</td>
				<td align="left"></td>
		...
		<table align="center" width="95%">
			...
			<?php
				...
				<tr>
					<td colspan="2">20=><?php echo $q20; ?>&nbsp;&nbsp;&nbsp;40=><?php echo $q40; ?>&nbsp;&nbsp;&nbsp;45=><?php echo $q45; ?></td>
					...
					<td colspan="6">
						<table align="left">
							...
							<tr>	
								...
								<td> : </td>
								<td><b>Ex. Currency is taken on the basis of vessel's arrival date.</b></td>
							</tr>
						</table>
					</td>
				</tr>
