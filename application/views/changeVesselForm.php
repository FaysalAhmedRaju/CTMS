    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <div class="clr"></div>
	<div class="img">
		<form action="<?php echo site_url("report/updateVslForExContPerformed");?>" method="post" onsubmit="return rtnConrfm()">
			...
			<input type="hidden" name="get" value="no">
				...
				<tr align="center">
					<td align="center">&nbsp;&nbsp;<b>Pre Rotation :</b></td>
					<td>
						<input type="text" name="pre_rot" class="login_input_text"/>
					</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
				...
				<tr align="center">
					<td align="center">&nbsp;&nbsp;<b>New Rotation :</b></td>
					<td>
						<input type="text" name="new_rot" class="login_input_text"/>
					</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
				...
				<tr align="center">
					<td align="center">&nbsp;&nbsp;<b>Container(s) No.:</b></td>
					<td>
