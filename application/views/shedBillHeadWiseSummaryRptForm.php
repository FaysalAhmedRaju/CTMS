    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  echo form_open(base_url().'index.php/ShedBillController/shedBillHeadWiseSummaryRptView',$attributes);
				...
				<table border="0" width="300px" align="center">
								...
								-->  
								 ...
								 <tr>
									...
									<td>
									<input type="text" style="width:150px;" id="from_dt" name="from_dt" > 
									</td>
									<script>
											 $(function() {
											 $( "#from_dt" ).datepicker({
								...
								<tr>
									   <td align="left" ><label><font color='red'></font>To Date :</label></td>
										<td>
										 <input type="text" style="width:130px;" id="to_dt" name="to_dt" value="<?php date("Y-m-d"); ?>" />
										</td>
											<script>
											 $(function() {
											 $( "#to_dt" ).datepicker({
								...
								<tr>
									<td align="left" ><label><font color='red'></font>Unit :</label></td>
									<td>
