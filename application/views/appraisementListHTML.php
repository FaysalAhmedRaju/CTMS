    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  echo form_open(base_url().'index.php/report/appraisementListFormList',$attributes);
			 ...
			 <table style="border:solid 1px #ccc;" width="350px" align="center" cellspacing="0" cellpadding="0">
				...
				<table border="0" width="500px" align="center">
								...
								-->  
								 ...
								 <tr>
									<td align="left" ><label for=""><font color='red'></font>Rotation No : <em>&nbsp;</em></label></td>
									<td>
									<input type="text" style="width:150px;" id="ddl_imp_rot_no" name="ddl_imp_rot_no" > 
									</td>
									<td align="left" ><label for=""><font color='red'></font>Bl No : <em>&nbsp;</em></label></td>
									<td>
									<input type="text" style="width:150px;" id="ddl_bl_no" name="ddl_bl_no" > 
									</td>								
								</tr>
								...
								<tr>
									...
									<?php echo form_close()?>
									<!--form action="<?php echo site_url('report/appraisementListFormList')?>" method="POST" target="_blank">
       ...
       <div id="table-scroll">
			<table  style="border:1px solid #ccc;" >
					<tr class="gridDark" align="center">
						...
						<td ><b>Rotation</b></td>
						<td ><b>Equipment</b></td>
						<td ><b>Appraise Date</b></td>
						<td ><b>Carpenter Use</b></td>
						<td ><b>Hosting Charge</b></td>
						<td ><b>Extra Movement</b></td>
						<td ><b>Scale For</b></td>
					...
					<tr class="gridLight" align="center">
						...
						<td style="color:red"><?php echo $rtnContainerList[$i]['BL_NO'];?></td>
						<td><?php echo $rtnContainerList[$i]['rotation'];?></td>
						<td><?php echo $rtnContainerList[$i]['equipment'];?></td>
						<td><?php echo $rtnContainerList[$i]['appraise_date'];?></td>
						<td><?php echo $rtnContainerList[$i]['carpainter_use'];?></td>
						<td><?php echo $rtnContainerList[$i]['hosting_charge'];?></td>
						<td><?php echo $rtnContainerList[$i]['extra_movement'];?></td>
						<td><?php echo $rtnContainerList[$i]['scale_for'];?></td>
					</tr>
					<?php }?>
				</table>
		 </div>
