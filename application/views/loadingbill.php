	...
	<div align ="center">
		<table align="center" width="95%">
			<tr>
				...
				<td align="left" style="width:10%">Bill Creator</td>
				<td align="left" >:</td>
				<td align="left" style="width:25%"><?php echo $bill_rslt[0]['created_user'];?></td>
			</tr>
			<tr>
				<td align="left">Nature Bill</td>
				<td align="left">:</td>
				<td align="left">LOADING BILL</td>
				<td align="left"></td>
			...
			<tr>
				...
				<td align="left"></td>
				<td align="left">O/B Visit No</td>
				<td align="left">:</td>
				<td align="left"><?php echo $bill_rslt[0]['vslId'];?></td>
			<tr>
		...
		<table align="center" width="95%">
			...
			<?php
				...
				<tr>
					...
					{
						$q20=$q20+$bill_rslt[$i]['quantityBilled'];
						$flag20=$flag20+1;
					}
					else if($bill_rslt[$i]['size']==40 and $flag40==0)
					{
						$q40=$q40+$bill_rslt[$i]['quantityBilled'];
						$flag40=$flag40+1;
					}
					else if($bill_rslt[$i]['size']==45 and $flag45==0)
					{
						$q45=$q45+$bill_rslt[$i]['quantityBilled'];
						$flag45=$flag45+1;
					}
					?>
					<td align="left"><?php if($bill_rslt[$i]['height']!="") echo number_format($bill_rslt[$i]['height'],1);?></td>
					...
					<td align="right"><?php echo number_format($bill_rslt[$i]['totalCharged'],2);?></td>
					<?php
						$amountTotal=$amountTotal+$bill_rslt[$i]['totalCharged'];
					?>
					<td align="right"><?php echo number_format($bill_rslt[$i]['totalvatamount'],2);?></td>
					<?php
						$vatTotal=$vatTotal+$bill_rslt[$i]['totalvatamount'];
					?>
					<td align="right"><?php echo number_format(($bill_rslt[$i]['totalCharged']+$bill_rslt[$i]['totalvatamount']),2);?></td>
					<?php
						$total=$total+$bill_rslt[$i]['totalCharged']+$bill_rslt[$i]['totalvatamount'];
					?>
				</tr>
				<?php   
				} 
			...
			<table align="center" width="95%">
				...
				<tr>
					...
					<!--td align="center" colspan="2"><?php echo $bill_rslt[0]['created_user'];?></td-->	<!-- uncomment if created_user is needed -->
					<td align="center" colspan="2"></td>		<!-- comment if created_user is needed -->
					<td align="center" colspan="2"></td>
				</tr>
				<tr>
					<td align="center" colspan="2">---------------------------</td>
