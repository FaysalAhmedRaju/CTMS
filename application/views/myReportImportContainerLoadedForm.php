    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  //echo form_open(base_url().'index.php/report/myImportContainerLoadedReportView',$attributes);
		  echo form_open(base_url().'index.php/report/chkImportLoadedContainerMloWise',$attributes);
						...
						<td>
							<table>
								...
								<tr>
										...
										<td align="left" ><label><font color='red'><b>*</b></font>Rotation:</label>
										<td>
