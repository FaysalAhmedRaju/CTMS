    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  echo form_open(base_url().'index.php/report/myExportExcelUploadSampleReportViewPerform',$attributes);
		...
		<div class="img">
			 ...
			 <table style="border:solid 1px #ccc;" width="450px" align="center" cellspacing="0" cellpadding="0">
				...
				<table border="0" width="650px" align="center">
								...
								<tr><br />
									<td align="right" ><label for="rotation_no">Export Rotation No:</label></td>
									<td >
