    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  echo form_open(base_url().'index.php/report/vatStatusList',$attributes);
			 ...
			 <table style="border:solid 1px #ccc;" width="450px" align="center" cellspacing="0" cellpadding="0">
				...
				<table border="0" width="650px" align="center">
								...
								<tr><br />
									...
									<td >
										<input type="text" style="width:120px;" id="rotation_no" name="rotation_no" onblur="getMloName(this.value);"> 
										
									</td>
								</tr>
								<tr><br />
									<td align="right" ><label for="rotation_no">Select MLO :</label></td>
									<td >
										<select name="mloName" id="mloName">
