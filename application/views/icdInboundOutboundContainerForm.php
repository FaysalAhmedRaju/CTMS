    ...
    <div class="content_resize">
		<div class="mainbar">
			<div class="article">
				...
				<div class="clr"></div>
					<div class="img">
						<form name= "myForm" onsubmit="return(validation());" action="<?php echo site_url("report/icdInboundOutboundContainerReportView");?>" target="_blank" method="post">
							<table align="center" style="border:solid 1px #ccc;" width="350px"  cellspacing="0" cellpadding="0">
								...
								<tr>
									<th align="left"><label><font color='red'></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;VISIT TYPE:</label></th>
								...
								<tr>
								    <th><nobr>VISIT ID</nobr></th>
									<td colspan="2"><input type="text" class="read" style="width:135px;"  id="vist_id" name="vist_id" ></td>
