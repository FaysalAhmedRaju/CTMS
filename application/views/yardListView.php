    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  echo form_open(base_url().'index.php/report/yardListViewSearchList',$attributes);
		...
		<div class="img">
			 ...
			 <table style="border:solid 1px #ccc;" width="350px" align="center" cellspacing="0" cellpadding="0">
				...
				<table border="0" width="500px" align="center">
								 <tr>
									<td align="left" ><label for=""><font color='red'></font>TERMINAL : <em>&nbsp;</em></label></td>
									<td>
       ...
       <div id="table-scroll" align="center">
			<table  style="border:1px solid #ccc;" >
					...
					<tr class="gridLight" align="center">
						...
						<td><?php echo $rtnVesselList[$i]['terminal'];?></td>
						<td><?php echo $rtnVesselList[$i]['block'];?></td>
						<td><?php echo $rtnVesselList[$i]['block_cpa'];?></td>
					</tr>
					<?php }?>
				</table>
		 </div>
