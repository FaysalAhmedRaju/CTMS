...
<head>
		<table align="center" width="95%">
			...
			<tr>
				<td align="center"><b><font size="5"><?php echo $bill_rslt[0]['invoiceDesc'];?></font></b></td>
			</tr>	
		</table>	
		...
		<div align ="center">
			<table align="center" width="95%">
				...
				<tr>
					...
					<td colspan="4" align="left">: &nbsp;&nbsp;<?php echo $bill_rslt[0]['grt'];?></td>
				</tr>
				<tr>
					<td align="left">US$ EX.RATE(TK)</td>
					<td colspan="4" align="left">: &nbsp;&nbsp;<?php echo $bill_rslt[0]['exchangeRate'];?></td>
				</tr>
			</table>	
			<table align="center" width="95%">
				<tr>
