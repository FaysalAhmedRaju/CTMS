    ...
    <div class="content_resize_1">
      <div class="mainbar_1">
        <div class="article">
		  ...
		  echo form_open(base_url().'index.php/report/viewVesselListImportSearchList',$attributes);
       ...
       <div id="table-scroll">
			<table  style="border:1px solid #ccc;" >
					...
					<tr class="gridLight" align="center">
						...
						<td><?php echo $rtnVesselList[$i]['mlo'];?></td>						
						<td><?php echo $rtnVesselList[$i]['bop'];?></td>						
						<td 
						...
						<?php echo $rtnVesselList[$i]['phase'];?></td>
