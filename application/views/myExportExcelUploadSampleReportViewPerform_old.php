...
/* if($fromdate!="" and $todate!="")	
{
	...
	//echo$vvdGkey;
	$strQuery = "select ctmsmis.mis_exp_unit.gkey,concat(substring(ctmsmis.mis_exp_unit.cont_id,1,4),substring(ctmsmis.mis_exp_unit.cont_id,5)) as id,sparcsn4.ref_equip_type.id as iso,RIGHT(sparcsn4.ref_equip_type.nominal_length,2) AS size,RIGHT(sparcsn4.ref_equip_type.nominal_height,2) AS height,mis_exp_unit.cont_mlo AS mlo,ctmsmis.mis_exp_unit.craine_id,ctmsmis.mis_exp_unit.seal_no,cont_status as freight_kind,ctmsmis.mis_exp_unit.goods_and_ctr_wt_kg as weight,ctmsmis.mis_exp_unit.coming_from AS coming_from,ctmsmis.mis_exp_unit.pod,ctmsmis.mis_exp_unit.stowage_pos,ctmsmis.mis_exp_unit.last_update,ref_commodity.short_name,ctmsmis.mis_exp_unit.user_id,ctmsmis.mis_exp_unit.truck_no
