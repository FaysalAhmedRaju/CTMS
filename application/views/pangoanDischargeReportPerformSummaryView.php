...
<?php
	...
	$sqlQry="SELECT IF(mlo IS NULL,'T',mlo) AS mlo,
			...
			(CASE WHEN RIGHT(sparcsn4.ref_equip_type.nominal_length,2) = '20' AND RIGHT(sparcsn4.ref_equip_type.nominal_height,2)='86'  AND sparcsn4.ref_equip_type.iso_group IN ('TN','TD','TG')  THEN 1  
