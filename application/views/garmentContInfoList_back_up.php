...
<table width="100%" border ='1' cellpadding='0' cellspacing='0'>
	<tr bgcolor="#ffffff" align="center" height="100px">
		<td colspan="12"><img align="middle"  width="235px" height="75px" src="<?php echo IMG_PATH?>cpanew.jpg"><br/><font size="4"><b>GARMENTS ITEM CONTAINER LIST</b></font></td>
	</tr>
	<!--tr bgcolor="#ffffff" align="center" height="100px">
		<td colspan="14" align="center"><font size="5"><b>GARMENTS ITEM CONTAINER LIST</b></font></td>
	</tr-->
	<tr bgcolor="#ffffff" align="center" height="25px">
		<td colspan="7"><b>Vessel Name:  </b><?php echo $row1->name.","; ?><b>  Rotation:  </b><?php echo $ddl_imp_rot_no.","; ?><b>  Date of Arrival:  </b><?php echo $row1->arrival; ?></td>		
	</tr>
	<tr bgcolor="#ffffff" align="center" height="25px">
