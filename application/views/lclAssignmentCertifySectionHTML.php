    ...
    <div class="content_resize_1">
      <div class="mainbar_1">
        <div class="article">
		  ...
		  //,'target'=>'_BLANK'
		  echo form_open(base_url().'index.php/report/lclAssignmentCertifyList',$attributes);
    ...
    vsl_vessel_visit_details ww ON ww.vvd_gkey = i.gkey where ib_vyg='$rotaionNo' and a.id='$containerNo1'
		...
		?>
					...
					<tr class="gridLight">
						...
						<th width="150px">Consignee Description</th><th>:</th><td><?php print($rtnContainerList[$i]['ConsigneeDesc']);  ?></td>
						<th>Notify Description</th><th>:</th><td><?php print($rtnContainerList[$i]['NotifyDesc']); ?></td>
					</tr>
					<tr class="gridLight">	
						<th>Yard / Shed</th><th>:</th><td><?php print($rtnContainerList[$i]['shed_yard']);  ?></td>
						<th>Position</th><th>:</th><td><?php print($rtnContainerList[$i]['shed_loc']);  ?></td>
	...
	<form action="<?php echo site_url('report/lclAssignmentVerify');?>" method="POST" name="myChkForm" onsubmit="return(validate());">
		...
		<table border=0 cellspacing="2" cellpadding="1"  width="80%" bgcolor="#2AB1D6">
			...
			<tr class="gridDark">
				...
				<th>C&f Name</th><th>:</th><td><input type="text" id="strCnfCode" value="<?php echo $rtnContainerList[$i]['cnf_name'];?>" name="strCnfCode" style="width:200px;"/></td>
			</tr>
			<tr class="gridLight" >
