    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  echo form_open(base_url().'index.php/report/isoCodeListViewSearchList',$attributes);
		...
		<div class="img">
			 ...
			 <table style="border:solid 1px #ccc;" width="350px" align="center" cellspacing="0" cellpadding="0">
				...
				<table border="0" width="500px" align="center">
								 <tr>
									<td align="left" ><label for=""><font color='red'></font>ISO CODE : <em>&nbsp;</em></label></td>
									<td>
       ...
       <div id="table-scroll" style="margin-left:2%;">
			<table  style="border:1px solid #ccc;" >
					...
					<tr class="gridLight" align="center">
						...
						<td><?php echo $rtnVesselList[$i]['cont_iso_type'];?></td>
						<td><?php echo $rtnVesselList[$i]['cont_size'];?></td>
						<td><?php echo $rtnVesselList[$i]['cont_height'];?></td>
						<td><?php echo $rtnVesselList[$i]['cont_type'];?></td>
					</tr>
					<?php }?>
				</table>
		 </div>
