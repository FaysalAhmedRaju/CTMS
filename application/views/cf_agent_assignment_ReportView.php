...
//			}
		...
		?>
		<tr>
			<td colspan="15"><b><?php  echo "Assignment Type:  ".$row->mfdch_desc;?></b></td>
		</tr>
		<?php
		$i=1;
	}?>
...
<!--		<tr>
	...
	<?php } ?>
			...
			<td><?php if($row->delivery_dt) echo $row->delivery_dt; else echo "&nbsp;";?></td>
                        <td><?php if($row->delivery_time) echo $row->delivery_time; else echo "&nbsp;";?></td>
                        <td><?php 
...
//                        
                         if($row->mfdch_desc=="Appraise Cum Delivery 2 High") 
                                {
                             echo "02.00PM - 05.00PM";                             
                                }
						 else if($row->mfdch_desc=="Appraise Cum Delivery Ground") 
                                {
                             echo "02.00PM - 05.00PM";                             
                                }		
                       else if(strpos($row->mfdch_desc,"reefer"))
                               {
