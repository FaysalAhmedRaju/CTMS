    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  echo form_open(base_url().'index.php/report/contListEmptyGateOutByRotationDownloadView',$attributes);
				...
				<table border="0" width="300px" align="center">
								...
								<tr>
									<td align="left" ><label><font color='red'></font>From Date:</label></td>
										<td>
										  <input type="text" style="width:130px;" id="fromDt" name="fromDt" value="<?php date("Y-m-d"); ?>" />
										</td>
											<script>
											 $(function() {
											 $( "#fromDt" ).datepicker({
								...
								<tr>
									<td align="left" ><label><font color='red'></font>To Date:</label></td>
										<td>
										  <input type="text" style="width:130px;" id="toDt" name="toDt" value="<?php date("Y-m-d"); ?>" />
										</td>
											<script>
											 $(function() {
											 $( "#toDt" ).datepicker({
