		...
		<div align ="center">
			<table align="center" width="95%">
				...
				<tr>
					...
					<td align="left">: &nbsp; OFFHIRE BILL</td>
					<td align="left"></td>
					<td align="left">Rotation No</td>
					<td align="left">: &nbsp; As Per List Attach</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="left"></td>
					<td align="left">Yard Out Date</td>
					<td align="left">: &nbsp;&nbsp;<?php echo $bill_rslt[0]['yardout'];?></td>
				</tr>
				<tr>
					<td align="left">Bill Creator</td>
					<td align="left">: &nbsp;&nbsp;<?php echo $bill_rslt[0]['created_user'];?></td>
					<td align="left"></td>
					<td align="left">Comm.Land Date</td>
					<td align="left">: &nbsp;&nbsp;<?php echo $bill_rslt[0]['fcl_declaration_date'];?></td>
				</tr>
			</table>	
