    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  echo form_open(base_url().'index.php/report/chkMloWiseFinalDischargingExportN4',$attributes);
					...
					<!--tr>		
						...
						<td>
							<table>
								<tr>
										<td align="left">
										<label for="Excel" style="font-size:11px;width:100%;margin:0;padding:0;text-align:left;width:75%;">Rotation</label>
									...
									<td align="left">
										<label for="HTML" style="font-size:11px;width:100%;margin:0;padding:0;text-align:left;width:75%;">Date</label>
										<?php 	$data = array(
													'name'        => 'options1',
													'id'          => 'options1',
													'value'       => 'date',
								...
								<tr>
										...
										<td align="left" colspan="2">
											<label><font color='red'><b>*</b></font>Rotation:</label>
											<input type="text" name="ddl_imp_rot_no" id="ddl_imp_rot_no" style="width:120px;" >												
										</td>
										<!--td align="left">
											<input type="text" name="ddl_imp_rot_no" id="ddl_imp_rot_no" style="width:120px;" >	
										</td-->
								...
								<tr>
									<td align="left">
										<label for="Excel" style="font-size:11px;margin:0;padding:0;text-align:left;">Excel</label>
									<?php 	$data = array(
													'name'        => 'options',
													'id'          => 'options',
													'value'       => 'xl',
								...
								<tr>
									<td align="left">
										<label for="HTML" style="font-size:11px;margin:0;padding:0;text-align:left;width:5%;">HTML</label>
										<?php 	$data = array(
													'name'        => 'options',
													'id'          => 'options',
													'value'       => 'html',
								...
								<tr>
									<td align="center" width="20px">
										<?php $arrt = array('name'=>'detail','id'=>'submit','value'=>'Detail','class'=>'login_button'); echo form_submit($arrt);?>
										<?php $arrt = array('name'=>'summary','id'=>'submit','value'=>'Summary','class'=>'login_button'); echo form_submit($arrt);?>
									</td>
