    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  echo form_open(base_url().'index.php/report/countryWiseImportReportView',$attributes);
			...
			<table style="border:solid 1px #ccc;" width="300px" align="center" cellspacing="0" cellpadding="0">
				...
				<table border="0" width="450px" align="center">
								...
								<tr>
									<tr><br />
									<td align="left"><label for=""><em>&nbsp;</em>Country Name:<em>&nbsp;</em></label></td>
									<td>
									<input type="text" style="width:150px;" id="countryName" name="countryName"> 
									</td>
								</tr>
