    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  echo form_open(base_url().'index.php/report/contListOffDockByRotationDownloadView',$attributes);
				...
				<table border="0" width="300px" align="center">
								...
								-->  
								 ...
								 <tr>
									...
									<td>
									<input type="text" style="width:150px;" id="off_date_from" name="off_date_from" > 
									</td>
									<script>
											 $(function() {
											 $( "#off_date_from" ).datepicker({
											  changeMonth: true,
											  changeYear: true,
								...
								<tr>
									   <td align="left" ><label><font color='red'></font>To Date:</label></td>
										<td>
										 <input type="text" style="width:130px;" id="off_date_to" name="off_date_to" value="<?php date("Y-m-d"); ?>" />
										</td>
											<script>
											 $(function() {
											 $( "#off_date_to" ).datepicker({
											  changeMonth: true,
											  changeYear: true,
											  dateFormat: 'yy-mm-dd', // iso format
											 });
