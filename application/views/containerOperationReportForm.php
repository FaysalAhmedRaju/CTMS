    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  echo form_open(base_url().'index.php/report/containerOperationReportList',$attributes);
		...
		<div class="img">
			 ...
			 <table style="border:solid 1px #ccc;" width="450px" align="center" cellspacing="0" cellpadding="0">
				...
				<table border="0" width="650px" align="center">
								...
								<tr><br />
									<td align="left" ><label for="searchDt">Date:</label>
									<script>
											  $(function() {
												$( "#searchDt" ).datepicker({
													changeMonth: true,
									...
									<label>
										...
										<input type="text" style="width:120px;" id="searchDt" name="searchDt"> 
									</td>
								</tr>
								<tr>
									<td align="left" >
