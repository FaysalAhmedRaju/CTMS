    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  echo form_open(base_url().'index.php/report/contListDischargeByRotationDownloadView',$attributes);
				...
				<table border="0" width="300px" align="center">
								...
								-->  
								 ...
								 <tr>
									...
									<td>
									<input type="text" style="width:150px;" id="dis_date_from" name="dis_date_from" > 
									</td>
									<script>
											 $(function() {
								...
								<tr>
									   <td align="left" ><label><font color='red'></font>To Date:</label></td>
										<td>
										 <input type="text" style="width:130px;" id="dis_date_to" name="dis_date_to" value="<?php date("Y-m-d"); ?>" />
										</td>
											<script>
											 $(function() {
