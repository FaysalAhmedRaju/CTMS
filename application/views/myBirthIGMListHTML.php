<?php 
	...
	{ 
		...
		{			
			?>
			<script type="text/javascript" src="<?php echo JS_PATH; ?>getagentBrac.js"> </script>
			<?php
		}
	} 
?>
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  echo form_open(base_url().'index.php/report/myBirthIGMListView',$attributes);
		...
		<div class="img">
		 ...
		 <table align="center" border=0>		
						...
						<tr align="center">
							<br />
							<td align="right" ><label for="rotation_no">Rotation_No:<em>&nbsp;</em></label></td>
							<td align="left" colspan="2">
							<?php 
								$attribute = array('name'=>'ddl_imp_rot_no','id'=>'txt_login','class'=>'login_input_text','onblur'=> "myShowMLO(this);" );
						...
						<tr>
									...
									<td align="left">
									<label for="Both" style="font-size:11px;width:100%;margin:0;padding:0;text-align:left;width:75%;">BOTH</label>
									<?php 	$data = array(
													'name'        => 'CStatus',
													'id'          => 'options',
													'value'       => 'Both',
										...
										<td align="left">
										<label for="FCL" style="font-size:11px;width:100%;margin:0;padding:0;text-align:left;width:75%;">FCL</label>
										<?php 	$data = array(
													'name'        => 'CStatus',
													'id'          => 'options',
													'value'       => 'FCL',
										...
										<td align="left">
										<label for="LCL" style="font-size:11px;width:100%;margin:0;padding:0;text-align:left;width:75%;">LCL</label>
										<?php 	$data = array(
													'name'        => 'CStatus',
													'id'          => 'options',
													'value'       => 'LCL',
