		...
		?>
			    ...
			    <tr >
					...
					//load container detail
						...
						$result1 = mysql_query("select cnt.id as id, cnt.cont_number as cont_number, cnt.cont_size as cont_size,cnt.cont_type as cont_type,cnt.cont_height as cont_height,cnt.cont_status as cont_status,cnt.cont_weight as cont_weight,cnt.cont_seal_number as cont_seal_number,cnt.cont_description as cont_description,cnt.cont_imo as cont_imo, cnt.cont_un as cont_un,Organization_Name from igm_sup_detail_container cnt join organization_profiles org on org.id=cnt.off_dock_id where cnt.igm_sup_detail_id=$row->id");
