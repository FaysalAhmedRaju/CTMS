	...
	<body>
		...
		<div class="pagewidth">
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
				<thead>
					<tr>
						<td colspan="4" align="center"><h2>CHITTAGONG PORT AUTHORITY</h2></td>
					</tr>
					<tr>
						<td colspan="4" align="center"><h3>OFFICE OF THE TERMINAL MANAGER</h3></td>
					</tr>
					<tr>
						<!--td colspan="8" style="padding-left:300px">Date: <?php echo $date?></td-->
					...
					<!--tr>
						<td style="border:1px solid black" align="center" width="20px" height="25px"><b>SL</b></td>
						<td style="border:1px solid black" align="center" width="100px" height="25px"><b>Cont No.</b></td>
						<!--td style="border:1px solid black" align="center" width="10px" height="25px"><b>Sz</b></td-->
						<!--td style="border:1px solid black" align="center" width="350px" height="25px"><b>B/E Info</b></td-->
						<!--td style="border:1px solid black" align="center" width="350px" height="25px"><b>Cart Details</b></td>
						<td style="border:1px solid black" align="center" width="100px" height="25px"><b>Signature & Mobile</b></td>
					</tr-->
				</thead>
				<?php 
				...
				?>
					...
					<tr>
						<td style="border:1px solid black;font-size:16px;" align="center" height="30px" width="20px"><b><?php echo $j;?></b></td>
						<td style="border:1px solid black;font-size:16px;" colspan="3" height="30px"><b><?php echo "C&F: ".$rowAllData->cf.", Vessel: ".$rowAllData->v_name.", Rotation: ".$rowAllData->rot_no.", BL No: ".$rowAllData->bl_no;?></b></td>
					</tr>
					<?php
					$rotation=$rowAllData->rot_no;
					$blno=$rowAllData->bl_no;
					
					$sql_stc="SELECT CONCAT(Pack_Number,' ',Pack_Description) AS stc,concat(weight,' KG') as weight FROM igm_details WHERE Import_Rotation_No='$rotation' AND BL_No='$blno'";
