...
<script language="JavaScript">
    function validation()
    {
        if( document.import_cargo_form.shed_no.value == "" )
        {
            alert( "Please provide Shed No!" );
            document.import_cargo_form.shed_no.focus() ;
            return false;
        }

        if( document.import_cargo_form.importCargodate.value == "" )
        {
            alert( "Please provide Date!" );
            document.import_cargo_form.importCargodate.focus() ;
            return false;
        }
        return true ;
    }
    ...
    <div class="content_resize_1">
        <div class="mainbar_1">
            <div class="article">
                ...
                <?php
                $attributes = array('name' => 'import_cargo_form', 'id' => 'import_cargo_form','target'=>'_BLANK', 'onsubmit'=>'return validation()');

                //,'target'=>'_BLANK'
                echo form_open(base_url().'index.php/report/importCargoReport',$attributes);
...
<!--                                    </tr>-->
                                    <tr>
                                        <td align="left" ><label for=""><font color='red'></font><nobr>SHED NO :<nobr><em>&nbsp;</em></label></td>
                                        <td colspan="2">
                                            <select name="shed_no" id="shed_no">
                                                <option value="">--------Select--------</option>
                                                <?php for($i=0; $i<count($shed_yard); $i++){ ?>

                                                    <option value="<?php echo $shed_yard[$i]['shed_yard'];?>"><?php echo $shed_yard[$i]['shed_yard'];?></option>
...
<!--                                        <td>-->
<!--                                            <!--disabled-->
<!--                                            <input type="text" style="width:150px;" id="shed_no" name="shed_no" >-->
<!--                                        </td>-->
                                    </tr>


                                    <tr colspan="4">
                                        <td align="left" ><label><font color='red'></font>Date:</label></td>
                                        <td>
                                            <input type="text" style="width:130px;" id="importCargodate" name="importCargodate" value="<?php date("Y-m-d"); ?>" />
                                        </td>
                                        <script>
                                            $(function() {
                                                $( "#importCargodate" ).datepicker({
                                                    changeMonth: true,
                                                    changeYear: true,
                                    ...
                                    <tr align="center">
                                        <td colspan="4" align="center" width="70px">
                                            <?php $arrt = array('name'=>'report','id'=>'submit','value'=>'View','class'=>'login_button'); echo form_submit($arrt);?>
                                        </td>
                                    </tr>
                                </table>
                            </td>
