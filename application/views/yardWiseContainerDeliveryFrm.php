    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  echo form_open(base_url().'index.php/report/yardWiseContainerDeliveryView',$attributes);
		...
		<div class="img">
		 ...
		 <table align="center" border ="0">
						<tr>				
							<td align="right" ><label for="block">Assignment Date:<em>&nbsp;</em></label></td>
							<td align="left" >
								<input type="text" id="assDt" class="login_input_text" name="assDt" >
									<script>
											  $(function() {
												$( "#assDt" ).datepicker({
													changeMonth: true,
