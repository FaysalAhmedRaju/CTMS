    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  echo form_open(base_url().'index.php/report/garmentContInfoList',$attributes);
		...
		<div class="img">
			 ...
			 <table style="border:solid 1px #ccc;" width="350px" align="center" cellspacing="0" cellpadding="0">
				...
				<table border="0" width="300px" align="center">
								...
								<tr><br />
									<td align="right" ><label for="rotation_no"><nobr>Import Rotation No:</nobr><em>&nbsp;</em></label></td>
									<td align="left" >
