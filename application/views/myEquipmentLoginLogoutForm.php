    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  echo form_open(base_url().'index.php/report/myEquipmentLoginLogoutView',$attributes);
					...
					<tr>
						<td align="center" colspan="3"></td>
								...
								<tr>
									...
									<tr>
										<td>
										<label for="field3"><font color='red'><b>*</b></font>Shift:</label></td>
										<td>
											<select name="shift" id="shift" class="">
									...
									<tr>										
										...
										<td>
											<div id="combo" style="display:none;">
												<select name="serch_value" id="serch_value" class="">
