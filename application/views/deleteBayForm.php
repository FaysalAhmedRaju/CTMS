    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <div class="clr"></div>
	<div class="img">
		<form action="<?php echo site_url("report/deleteBayPerformed");?>" method="post" onsubmit="return rtnConrfm()">
			...
			<input type="hidden" name="get" value="no">
				...
				<tr align="center">
					...
					<td>
						<input type="text" name="ddl_imp_rot_no" class="login_input_text"/>
					</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
				...
				<tr align="center">
					<td align="center">&nbsp;&nbsp;<b>Bay No.:</b></td>
					<td>
						<select name="sValue" class="login_input_text">
