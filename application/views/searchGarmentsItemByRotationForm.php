    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  echo form_open(base_url().'index.php/report/searchGarmentsItemByRotationList',$attributes);
		...
		<div class="img">
			 ...
			 <table style="border:solid 1px #ccc;" width="350px" align="center" cellspacing="0" cellpadding="0">
				...
				<table border="0" width="300px" align="center">
								...
								<tr><br />
									<td align="right" ><label for="rotation_no">Item Name:<em>&nbsp;</em></label></td>
									<td align="left" >
									
										<?php 
											$attribute = array('name'=>'ddl_imp_item','id'=>'txt_login','class'=>'login_input_text');
											echo form_input($attribute,set_value('ddl_imp_item'));
										?>
									</td>
								</tr>		
								<tr><br />
