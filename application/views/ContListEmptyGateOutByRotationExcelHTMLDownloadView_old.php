...
<?php
	include("dbConection.php");
			...
			/*$str = "SELECT sparcsn4.vsl_vessel_visit_details.ib_vyg,sparcsn4.inv_unit.id,sparcsn4.inv_unit_fcy_visit.time_out	
					...
					WHERE DATE(sparcsn4.inv_unit_fcy_visit.time_out) between '$fromDt' and '$toDt' and  
					(sparcsn4.inv_unit.freight_kind='MTY') and sparcsn4.ref_bizunit_scoped.id='PIL' ORDER BY 3";*/
					$str=" SELECT (SELECT sparcsn4.inv_unit_fcy_visit.flex_string10 FROM sparcsn4.inv_unit
					 INNER JOIN sparcsn4.inv_unit_fcy_visit ON sparcsn4.inv_unit_fcy_visit.unit_gkey=sparcsn4.inv_unit.gkey
					 WHERE id=tbl.id AND sparcsn4.inv_unit.category='IMPRT' ORDER BY sparcsn4.inv_unit.gkey DESC LIMIT 1
					 ) AS ib_vyg,id,time_out,last_pos_name
					 FROM (
