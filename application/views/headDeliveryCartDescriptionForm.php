    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  echo form_open(base_url().'index.php/report/offDockRemovalPositionList',$attributes);
		...
		<div class="img">
			 ...
			 <table style="border:solid 1px #ccc;" width="450px" align="center" cellspacing="0" cellpadding="0">
				...
				<table border="0" width="650px" align="center">
								...
								<tr><br />
									<td align="left" ><label for="rotation_no">ROTATION NO:</label></td>
									<td >
										<input type="text" style="width:120px;" id="rotation_no" name="rotation_no" onblur="getBlNo(this.value);"> 
									</td>
								</tr>
								<tr>
									<td align="left" ><label for=""><font color='red'></font>BL NO :<em>&nbsp;</em></label></td>
									<td>
										<select name="bl_no" id="bl_no" onchange="getContainerNo(this.value);">
											<option style="width:110px;" value="all">--SELECT--</option>
										</select>
									</td>
								</tr>
								<tr>
									<td align="left" ><label for=""><font color='red'></font>Container No :<em>&nbsp;</em></label></td>
									<td>									
										<select name="cont_no" id="cont_no" onchange="">
