    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  echo form_open(base_url().'index.php/report/contListStripingByRotationDownloadView',$attributes);
			 ...
			 <table style="border:solid 1px #ccc;" width="350px" align="center" cellspacing="0" cellpadding="0">
				...
				<table border="0" width="300px" align="center">
								...
								<tr>
								 ...
								 <tr>
									<td align="left" ><label for=""><font color='red'></font>From Date :<em>&nbsp;</em></label></td>
									<td>
									<input type="text" style="width:150px;" id="stripping_date_from" name="stripping_date_from" > 
									</td>
									<script>
											 $(function() {
											 $( "#stripping_date_from" ).datepicker({
											  changeMonth: true,
											  changeYear: true,
								...
								<tr>
									   <td align="left" ><label><font color='red'></font>To Date:</label></td>
										<td>
										 <input type="text" style="width:130px;" id="stripping_date_to" name="stripping_date_to" value="<?php date("Y-m-d"); ?>" />
										</td>
											<script>
											 $(function() {
											 $( "#stripping_date_to" ).datepicker({
											  changeMonth: true,
											  changeYear: true,
											  dateFormat: 'yy-mm-dd', // iso format
											 });
