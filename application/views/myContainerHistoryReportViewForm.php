    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  echo form_open(base_url().'index.php/report/myContainerHistoryReport',$attributes);
			...
			<div class="img">
			 ...
			 <table style="border:solid 1px #ccc;" width="300px" align="center" cellspacing="0" cellpadding="0">
				...
				<table border="0" width="450px" align="center">
								...
								<tr>
									<tr><br />
									<td align="left" ><label for=""><font color='red'><b>*</b></font>CONTAINER N0:<em>&nbsp;</em></label></td>
									<td>
