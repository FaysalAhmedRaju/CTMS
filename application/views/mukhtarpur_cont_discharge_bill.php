		...
		<div align ="center">
			<table align="center" width="95%">
				...
				<tr>
					...
					<td align="left">: &nbsp; DISCHARGING BILL (Muktarpur)<!--?php echo $bill_rslt[0]['vesselName'];?--></td>
					<td align="left"></td>
			...
			<table align="center" width="95%">
				...
				<tr>
					...
					<td align="right"><?php $sum= $bill_rslt[$i]['amt'] + $bill_rslt[$i]['vat']; echo $sum; $sumTotal=$sumTotal+$sum;?></td>	
				</tr>
				<?php  } ?>
				<tr>
					<td colspan="9">
				...
				<tr>
					<!--td align="center"> 20 => <?php echo $size20;?></td>
					<td align="center"> 40 => <?php echo $size40;?></td>
					<td align="center"> 45 => <?php echo $size45;?></td-->
			...
			<table align="center" width="85%">	
				...
				<tr>
					<td colspan="6" align="left">Net Payable BDT :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><?php  echo $sumTotal; ?></b></td>
				</tr>	
				<tr>	
					<td colspan="6" align="left">In Words :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><?php  echo numtowords($sumTotal)." only"; ?></b></td>					
				</tr>
				<tr>	
					<td colspan="6" align="left">Remarks :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php  echo $bill_rslt[0]['comments']; ?></td>					
				</tr>
				<tr>	
					<td colspan="6" align="left">&nbsp;</td>					
				</tr>
				<tr>	
					<td colspan="6" align="left">Ex. Currency is taken on the basis of vessel's arrival date</td>					
				</tr>
			</table>
			<table align="center" width="85%">
				<tr>
