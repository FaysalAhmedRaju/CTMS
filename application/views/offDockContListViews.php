...
<?php
	...
	(select last_pos_name from sparcsn4.inv_unit_fcy_visit where sparcsn4.inv_unit_fcy_visit.unit_gkey=mis_exp_unit_preadv_req.gkey limit 1) as last_pos_name
